        ...
        <div className="container px-5 py-8 mx-auto">
          <div className="lg:w-4/5 mx-auto flex flex-wrap">
            <div className="lg:w-1/2 w-full lg:pr-10 lg:py-6 mb-6 lg:mb-0">
              ...
              <h1 className="text-red-600 text-xl md:text-3xl title-font font-medium mb-4">Order Id: #{order.orderId}</h1>
              <p className="leading-relaxed mb-4 text-red-400">Your item has not been placed.</p>
              <p className="leading-relaxed mb-4 text-sm">Order failed on: {date && date.toLocaleDateString("en-IN", { weekday: 'long', year: 'numeric', month: 'long', day: 'numeric' })}</p>
              <p className="leading-relaxed mb-4">Order Status: <span className='text-red-500 font-medium'>{order.status}</span>.</p>
