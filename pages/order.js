        ...
        <div className="container px-5 py-8 mx-auto">
          <div className="lg:w-4/5 mx-auto flex flex-wrap">
            <div className="lg:w-1/2 w-full lg:pr-10 lg:py-6 mb-6 lg:mb-0">
              ...
              <p className="leading-relaxed mb-4">Your item has been succesfully placed.</p>
              ...
              <p className="leading-relaxed mb-4">Order Status: <span className='text-slate-500 font-medium'>{order.status}</span>.</p>
